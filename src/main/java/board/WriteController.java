...
public class WriteController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		req.getRequestDispatcher("/vsCode/board-write.jsp").forward(req, resp);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			 ...
			 */
			JSFunction.alertLocation(resp, "파일 업로드 오류입니다.", "../vsCode/board-write.do");
			e.printStackTrace();
			return;
		}
		...
		if (result == 1) {
			resp.sendRedirect("../vsCode/board-list.do");
		}
		else { // 글쓰기 실패
			JSFunction.alertLocation(resp, "글쓰기에 실패했습니다.", "../vsCode/board-write.do");
		}
	}

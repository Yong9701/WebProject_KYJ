    ...
    <div class="contents">
      <div class="inner">
        <div class="board_view">
          <div class="tit_wrap">
            <h2>명랑핫도그, 배달의민족 기획전 진행… 할인 쿠폰 제공</h2>
            <div class="detail">
              <p>작성자 : 관리자</p>
              <p>작성일 : 2024-04-23</p>
              <p>조회수 : 9999</p>
          ...
          <div class="board_txt">
            <div class="board_img">
              <img src="images/board_view_image1.jpg" alt="배민배달할인">
            </div>
            <div class="txt_wrap">
        ...
        <div class="board_list_btn">
          <a class="list_btn" href="download-edit.jsp">수정</a>
          <a class="list_btn" href="download.jsp">삭제</a>
          <a class="list_btn" href="download.jsp">목록</a>
        </div>
      </div>
    </div>
   </main>

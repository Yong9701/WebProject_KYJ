    ...
    <div class="sub_top">
      <div class="inner">
        ...
        <div class="sub_home">
          ...
          <div class="s_wrap">
            <button class="menu_btn" type="button">자료실</button>
            <ul class="s_menu">
    ...
    <div class="contents">
      <div class="inner">
        <div class="board_write">
            ...
            <caption class="nohead">게시물 작성</caption>
              <tbody>
                ...
                <tr>
                  ...
                  <td><input type="text" placeholder="작성자명"></td>
                </tr>
                <tr>
                  <th>연락처</th>
                  <td><input type="text" placeholder="000-0000-0000"></td>
                </tr>
                <tr>
                  <th>이메일</th>
                  <td><input class="email" type="text">@<input class="email2" type="text">
                ...
                <tr>
                  ...
                  <td colspan="3"><textarea placeholder="내용을 입력하세요."></textarea></td>
                </tr>
                <tr>
                  <th>첨부파일</th>
                  <td colspan="3"><input type="file">
                  <p>첨부파일의 용량은 20MB 이하로 첨부가능합니다.</p>
          ...
          <div class="btn_wrap">
            <a class="list_btn2" href="download-view.jsp">수정완료</a>
            <a class="list_btn2" href="download-view.jsp">취소</a>
          </div>
        </div>
      </div>
    </div>

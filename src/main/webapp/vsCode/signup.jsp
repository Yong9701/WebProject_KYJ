      ...
      <div class="inner">
          ...
          <script type="text/javascript">
		    ...
		    function checkId() {
		        ...
		        xhr.open("POST", "../vsCode/checkIdDuplicate.do", true);  // 서버 사이드 경로 설정
		    ...
		    function checkPasswordMatch() {
          	...
          	<form name="signupFrm" method="post" action="../vsCode/signup.do"
          		onsubmit="return validateForm(this);">
	            <div class="signup_row">
	              <input type="text" name="id" placeholder="아이디" oninput="useableId()">
	              <span id="useable_id_message">
	              	소문자, 숫자 조합 6~12글자이내로 입력하세요.
	              </span>
	              <br/>
	            ...
	            <div class="signup_row">
	              <input type="text" name="tel" placeholder="전화번호(-없이 숫자만 입력해주세요)">
	            </div>

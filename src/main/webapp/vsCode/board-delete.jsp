    ...
    <div class="contents">
      <div class="inner">
        <div class="delete_area">
          <form name="deleteForm" method="post" action="../vsCode/board-delete.do">
          	<input type="hid-den" name="idx" value="${ dto.idx }"/>
          	<input type="hid-den" value="${ dto.name }"/>
          	<input type="hid-den" value="${ dto.title }"/>
           	<p>해당 게시글을 삭제하시겠습니까?</p>
          	<button type="submit">예</button>
          	<button type="button" onclick="location.href='../vsCode/board-list.do'" >아니오</button>
          </form>
        </div>
      </div>
    </div>

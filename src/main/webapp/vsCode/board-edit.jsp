      ...
      <div class="inner">
        ...
        function validateForm(f) {
          ...
          <form name="writeFrm" method="post" enctype="multipart/form-data"
        		action="../vsCode/board-edit.do" onsubmit="return validateForm(this);">
	          <table>
	            <caption class="nohead">게시물 수정</caption>
	              <tbody>
	              	<tr>
	                  <td style="text-align:center;" colspan="4">
	                  	<input name="idx" type="hid-den" value="${ dto.idx }">
	                  </td>
	                </tr>
	                <tr>
	                  <th>작성자</th>
	                  <td colspan="3"><input type="hid-den" value="${ UserName }"></td>
	                </tr>
	                <tr>
	                  <th>제목<span class="red">*</span></th>
	                  <td colspan="3"><input name="title" type="text" placeholder="제목을 입력해주세요." value="${ dto.title }"></td>
	                </tr>
	                <tr>
	                  <th>내용<span class="red">*</span></th>
	                  <td colspan="3"><textarea name="content" placeholder="내용을 입력하세요.">${ dto.content }</textarea></td>
	                </tr>
	                <tr>
	                  <th>첨부파일</th>
	                  <td colspan="3"><input type="file" name="ofile" value="${ dto.ofile }">
		          ...
		          <div class="btn_wrap">
            		...
            		<button type="button" class="list_btn2" onclick="location.href='../vsCode/board-list.do'">목록바로가기</button>
            	  </div>
	         </form>
        </div>
      </div>

    ...
    <div class="contents">
      <div class="inner">
        ...
        <div class="board_list">
          <table>
            <caption>다운로드 테이블: 번호, 제목, 작성자, 등록일, 조회, 다운로드</caption>
              <thead>
                <tr>
                  <th class="col1">No</th>
                  <th class="col2">제목</th>
              ...
              <tbody>
                <tr>
                  <td>9999</td>
                  <td class="td_left"><a class="link_btn" href="download-view.jsp">명랑핫도그, 배달의민족 기획전 진행… 할인 쿠폰 제공</a></td>
                  <td>관리자</td>
                  <td>2024-04-23</td>
                  <td>9999</td>
                  <td>첨부파일</td>
          ...
          <a class="write_btn list_btn" href="download-write.jsp">작성</a>
        </div>
      </div>
    </div>
   </main>
